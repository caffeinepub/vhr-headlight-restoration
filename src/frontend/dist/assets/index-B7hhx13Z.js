    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal text-center mb-16", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-4xl md:text-5xl text-white mt-3 mb-4", children: "Our Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 max-w-md mx-auto", children: "Professional headlight restoration at your doorstep" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-2xl mx-auto", children: [
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 24 }),
            title: "Premium 2K Clear Coat",
            price: "£60",
            description: "Includes full sanding, machine polishing & 2K high-gloss UV protective clear coat (12–24 months durability).",
            popular: true
          },
          {
          ...
          "div",
          {
            ...
            children: [
              service.popular && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-brand-blue text-white text-xs font-bold uppercase tracking-widest rounded-full", children: "Most Popular" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `w-12 h-12 rounded-xl flex items-center justify-center mb-6 ${service.popular ? "bg-brand-blue text-white" : "bg-white/5 text-brand-blue-glow"}`,
                  children: service.icon
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-white mb-2", children: service.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-baseline gap-1 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-5xl text-white", children: service.price }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm leading-relaxed flex-1 mb-8", children: service.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: WHATSAPP_URL,
