...
function Nav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "nav.panel",
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-brand-dark/95 backdrop-blur-md border-b border-white/5 shadow-lg" : "bg-transparent"}`,
      children: [
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-brand-charcoal border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 flex flex-col gap-4", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-headlight.dim_1920x1080.jpg')"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-black/85 via-black/60 to-black/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-brand-dark/90 via-transparent to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand-blue/40 bg-brand-blue/10 text-brand-blue-glow text-sm font-medium mb-6 backdrop-blur-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14 }),
            "UK Mobile Headlight Restoration"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-[1.05] tracking-tight text-balance mb-6", children: [
            "Professional Headlight",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue-light", children: "Restoration" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "We Come to You"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-12 leading-relaxed", children: [
            "Fast, affordable & long-lasting results.",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/90 font-medium", children: "12+ months UV protection." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-4 sm:gap-6", children: [
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { size: 16 }), label: "Mobile Service" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 16 }), label: "Same Day Available" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 16 }), label: "UV Protected" }
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue-glow", children: badge.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, className: "text-green-400" }),
                badge.label
              ]
            },
            badge.label
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/30 animate-float", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gradient-to-b from-white/30 to-transparent" })
        ] })
      ]
    }
  );
...
function Services() {
  ...
  const services = [
    {
      ...
      locationIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 13 }),
      title: "At My Workshop",
      price: "£40",
      description: "Drop your car off at my location and pick it up fully restored. Same professional result, lower price.",
      features: [
    ...
    },
    {
      ...
      locationIcon: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { size: 13 }),
      title: "Mobile / Doorstep Service",
      price: "£60",
      description: "I travel to your home, workplace, supermarket car park, or anywhere convenient for you.",
      features: [
        "Full multi-stage wet sanding",
        "Machine polishing",
        "2K high-gloss UV protective clear coat",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue text-sm font-semibold uppercase tracking-widest", children: "Pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-4xl md:text-5xl text-white mt-3 mb-4", children: "Choose Your Option" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 max-w-md mx-auto", children: "Same premium 2K clear coat result — pick the location that works for you" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-2xl mx-auto", children: services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `services.item.${i + 1}`,
            className: `section-reveal card-hover relative flex flex-col rounded-2xl border p-8 ${service.popular ? "bg-brand-blue/10 border-brand-blue/50 shadow-blue-glow" : "bg-brand-charcoal border-white/8 shadow-card-dark"}`,
            style: { transitionDelay: `${i * 100}ms` },
            children: [
              service.badge && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-brand-blue text-white text-xs font-bold uppercase tracking-widest rounded-full", children: service.badge }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `w-12 h-12 rounded-xl flex items-center justify-center ${service.popular ? "bg-brand-blue text-white" : "bg-white/5 text-brand-blue-glow"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    className: `inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold ${service.popular ? "bg-brand-blue/20 text-brand-blue-light border border-brand-blue/30" : "bg-white/5 text-white/50 border border-white/10"}`,
                    children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-white mb-2", children: service.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-baseline gap-1 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-5xl text-white", children: service.price }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/55 text-sm leading-relaxed mb-5", children: service.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mb-8 flex-1", children: service.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  className: `w-full py-3 rounded-xl font-semibold text-center transition-all duration-200 hover:scale-[1.02] ${service.popular ? "bg-brand-blue hover:bg-brand-blue-light text-white" : "bg-white/5 hover:bg-white/10 text-white border border-white/10"}`,
                  children: "Book Now"
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-reveal mt-10 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-sm", children: [
          "⏱ Average job time:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 font-medium", children: "45–60 minutes for both headlights." })
        ] }) })
      ] })
    }
  );
...
function BeforeAfterSlider({
  ...
  const [position, setPosition] = reactExports.useState(50);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-amber-900/30" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: { left: `${position}%` },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center border-2 border-white/80", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0 h-0 border-y-4 border-y-transparent border-r-[6px] border-r-brand-charcoal" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0 h-0 border-y-4 border-y-transparent border-l-[6px] border-l-brand-charcoal" })
            ] }) })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4 px-3 py-1 bg-black/60 backdrop-blur-sm rounded-full text-white text-xs font-bold uppercase tracking-widest", children: "Before" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 px-3 py-1 bg-brand-blue/80 backdrop-blur-sm rounded-full text-white text-xs font-bold uppercase tracking-widest", children: "After" })
      ]
    }
  );
}
function Gallery() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue text-sm font-semibold uppercase tracking-widest", children: "Results" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-4xl md:text-5xl text-white mt-3 mb-4", children: "Before & After" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 max-w-md mx-auto", children: "Drag the slider to compare. The difference speaks for itself." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 text-sm text-center mt-3", children: "Premium 2K Clear Coat Result" })
        ] })
      ] })
    }
  );
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 md:py-32 bg-brand-dark",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-4 bg-brand-blue/10 rounded-3xl blur-2xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal", style: { transitionDelay: "150ms" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue text-sm font-semibold uppercase tracking-widest", children: "About" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-4xl md:text-5xl text-white mt-3 mb-6", children: "About Me" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 leading-relaxed text-lg mb-10", children: "I am an independent mobile headlight restoration technician based in the UK. I work personally on every vehicle, using professional equipment, multi-stage wet sanding, machine polishing and durable UV protection coatings to bring headlights back to a crystal-clear finish. My goal is simple: clean, safe, and like-new headlights — done with care, precision, and attention to detail." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-black text-2xl text-brand-blue-light mb-1", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/50 text-xs uppercase tracking-wide", children: stat.label })
              ]
            },
            stat.label
          )) })
...
Message: ${form.message}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 md:py-32 bg-brand-charcoal",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-blue text-sm font-semibold uppercase tracking-widest", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-4xl md:text-5xl text-white mt-3 mb-4", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50", children: "Ready to restore your headlights? Reach out now." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-reveal bg-brand-dark border border-white/5 rounded-2xl p-6 md:p-10 shadow-card-dark", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-center text-white/30 text-sm", children: "📍 Serving all areas within 15 miles from your city" })
        ] })
      ] })
    }
  );
    ...
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: "/assets/uploads/v-1.png",
                alt: "Vanko Headlight Restoration",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 text-sm leading-relaxed", children: "Professional mobile headlight restoration across the UK." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 text-xs font-semibold uppercase tracking-widest", children: "Quick Links" }),
            [
              { label: "Home", href: "#home" },
              { label: "Prices", href: "#prices" },
              { label: "Contact", href: "#contact" }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/60 text-xs font-semibold uppercase tracking-widest block mb-4", children: "Follow Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 18 })
                }
              )
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/5 pt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/30 text-sm text-center", children: [
          "© ",
          year,
          " Vanko Headlight Restoration. All rights reserved."
        ] }) })
      ] })
    }
  );
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-brand-dark", children: [
